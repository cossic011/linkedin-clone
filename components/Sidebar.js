    ...
    <div className="space-y-2 min-w-max">
      <div className="bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border border-gray-300 dark:border-none">
        <div className="relative w-full h-14">
          <Image src="https://rb.gy/i26zak" layout="fill" priority alt="user" />
        </div>
        <Avatar
          onClick={signOut}
      ...
      <div className="hidden md:flex bg-white dark:bg-[#1D2226] text-black/70 dark:text-white/75 overflow-hidden rounded-lg flex-col space-y-2 pt-2.5 sticky top-20 border border-gray-300 dark:border-none">
