...
import { modalOpen, modalType } from "../features/modal/modalSlice";
import { handlePost, handlePostState } from "../features/post/postSlice";
...
const Post = ({ post, modalPost }) => {
  ...
  const modalState = useSelector((state) => state.modal.modalState.default);
    ...
    >
      <div className="flex items-center px-2.5 cursor-pointer">
        ...
        <div className="mr-auto ml-2 leading-none">
          ...
          <Moment className="text-xs dark:text-white/75 opacity-80" fromNow>
            {post.createdAt}
          </Moment>
        </div>
        {modalPost ? (
          <IconButton onClick={() => dispatch(modalOpen())}>
